...
const layouts: Layouts = {
    [LAYOUT_INSET_SHELL]: lazy(() => import('./components/InsetShell')),
    [LAYOUT_STACKED_SIDE]: lazy(() => import('./components/StackedSide')),
    [LAYOUT_TOP_BAR_CLASSIC]: lazy(() => import('./components/TopBarClassic')),
    [LAYOUT_SEAMLESS_SIDE]: lazy(() => import('./components/SeamlessSide')),
    [LAYOUT_DUO_TIER_HEADER]: lazy(() => import('./components/DuoTierHeader')),
